...
public class L03_E10_NumerosPerfeitos {

    public static void main(String[] args) {
        System.out.println("---> LISTA 03 | EXERCÍCIO 10");
        System.out.println("---> Gerar e escrever os 5 primeiros números perfeitos\n");
        ...
        int numPerfeitosLimite = 5;

        // PERCORRER ENTRE OS NÚMEROS ATÉ ACHAR ALGUM NÚMERO PRIMO
        for (int i = 2; numPerfeitosAtuais < numPerfeitosLimite; i++) {
            ehPrimo = true;
            potencia = 1;
            mersennePrime = 1;
            numeroPerfeito = 0;
